                                ...
                                <ul id="nav" class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="nav-item"><a href="portfolio-single.html">Portfolio Single</a>
                                            </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll active dd-menu" href="javascript:void(0)">Blog</a>
                        ...
                        <div class="left-side-wrapper mb-60">
                            <div class="single-blog blog-style-2 mb-60 wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div class="blog-content">
                                    <h4>Start a Business Guide</h4>
                                    <p class="mb-40">Cum sequi recusandae incidunt rerum Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea corrupti, maiores at rerum repellat in. Soluta voluptatum in deserunt consequatur facere natus sunt facilis neque rem dicta! Cum sequi recusandae incidunt rerum ullam nostrum magni, suscipit, nesciunt ab quibusdam tempore exercitationem quisquam dolorem unde sed facilis quod voluptate esse cupiditate.</p>

                                    <p class="quote mb-40">Facere natus sunt facilis neque rem dicta! Cum sequi recusandae incidunt rerum ullam nostrum magni, suscipit, nesciunt ab quibusdam tempore exercitationem quisquam dolorem unde sed facilis quod voluptate esse cupiditate.</p>

                                    <p>Amet is havvy lass consectetur adipisicing elit. Ea corrupti, maiores at rerum repellat in. Soluta voluptatum in deserunt consequatur facere natus sunt facilis neque rem dicta! Cum sequi recusandae incidunt rerum ullam nostrum magni, suscipit, nesciunt ab quibusdam tempore exercitationem quisquam dolorem unde sed facilis quod voluptate esse cupiditate.</p>
                                </div>
                            </div>
                            ...
                            <div class="comment-form-wrapper ml-0">
                                <h2 class="mb-40">Leave a comment</h2>
                                <form action="#" class="comment-form">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <textarea name="message" id="message" placeholder="Type Comment" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
